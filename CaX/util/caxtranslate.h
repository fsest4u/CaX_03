...
#define STR_ADD_SHARE				TR("Add share")
...
#define STR_DELETE_SHARE			TR("Delete share")
...
#define STR_MODIFY_SHARE			TR("Modify share")
#define STR_MOVE              		TR("Move")
...
#define STR_RESERVE_RECORD_LIST		TR("Reservation recording list")
#define STR_SCAN_ON					TR("Scan Music DB")
#define STR_SCAN_OFF				TR("Remove from Music DB")
#define STR_SEARCH_COVERART			TR("Search coverart")
#define STR_SEEK_ALL				TR("Seek all")
#define STR_SELECT_ALL				TR("Select all")
#define STR_SETUP_RESERVE_RECORD		TR("Setup reservation recording")
...
#define STR_CANNOT_RENAME_AUTO_PLAY		TR("Can't rename Auto Play")
